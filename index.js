...
function addGamesToPage(games) {
    for (let i = 0; i < games.length; i++) {
        ...
        // Add the class 'game-card' to this div
        gameCard.classList.add("game-card");
    
        // Set the innerHTML of the card using a template literal
        gameCard.innerHTML = `
...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for 
    ${totalGames} ${totalGames === 1 ? "game" : "games"}. Currently, ${numUnfundedGames} 
